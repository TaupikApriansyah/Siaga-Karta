...
{
    protected $fillable = ['code','tracking_key_hash','citizen_id','type','category','source','status','pickup_location','destination','medical_condition','scheduled_at','service_start_at','service_end_at','ktp_path','ambulance_id','driver_id','handled_by','verified_by','verified_at','completed_at','internal_notes'];
