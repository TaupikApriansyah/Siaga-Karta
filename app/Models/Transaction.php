...
{
    protected $fillable=['request_uuid','code','type','category','amount','status','source','payer_name','payer_phone_encrypted','payer_phone_last4','payment_proof_path','payment_proof_hash','rejection_reason','program_id','description','transaction_date','created_by','verified_by','verified_at'];
    protected $hidden=['payer_phone_encrypted','payment_proof_path','payment_proof_hash'];
